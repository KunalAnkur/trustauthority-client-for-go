...
var (
	...
	EvidenceDataOptions    = CommandOptions{"evidence-data", "", "Base64 encoded TDX quote to attest. When set, evidence is not collected from the local platform, allowing the command to run on a host without a TEE"}
)
